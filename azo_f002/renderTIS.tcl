...
source azo_f002.viewpoints.tcl
...
if {$::VCR::render == 1} { 
  set ::VCR::dirName         ./imagesTIS/
  set ::VCR::filePrefixName  movie
  set ::VCR::logfile [open ./f002.origin.TIS.vmd.log w]
...
## Continuing
#set ::VCR::movieframe 5801
#set iframe 5803
#move_vp_movie 5803 3750 5900 3750 smooth
